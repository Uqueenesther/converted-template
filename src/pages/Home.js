  ...
  <header className="header">
    <div className="container">
      ...
      <div className="header-content">
        ...
        <h1 className="header-title"> Uwana</h1>
        <h6 className="header-mono">Frond end Designer | Developer</h6>
        <button className="btn btn-primary btn-rounded"><i className="ti-printer pr-2" />Print MyResume</button>
      </div>
    </div>
  </header>
      ...
      <div className="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
        ...
        <ul className="navbar-nav brand">
          ...
          <li className="brand-txt">
            <h5 className="brand-title"> Uwana</h5>
